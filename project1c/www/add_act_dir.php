      ...
      <aside>
        <div id="sidebar"  class="nav-collapse ">
          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="mt">
              <a class="active" href="div-mov.php" >
                <i class="fa fa-desktop"></i>
            ...
            <div class="row mt">
              <div class="col-lg-12">
                <div class="form-panel">
                  ...
                  <form class="form-horizontal style-form" method="get" action="<?php echo ($_SERVER["PHP_SELF"]);?>">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control" placeholder="Please type a first name..." name="fname">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control" placeholder="Please type a last name..." name="lname">
                        <span class="help-block">EX. Hanks</span>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control" placeholder="Please type a date of birth..." name="dob">
                        <span class="help-block">EX. 1995-01-22.</span>
                      </div>
                      <span class="error">* <?php echo $dobErr;?></span>
                    </div>

                    <div class="form-group">
                      <label class="col-sm-2 col-sm-2 control-label">Date of Death</label>
                      <div class="col-sm-7">
                        <input type="text" class="form-control" placeholder="Please type a date of death..." name="dod">
                        <span class="help-block">EX.1960-01-01.<br>Leave it empty if alive.</span>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <div class="radio">
                          <label>
                            <input type="radio" name="job" value="Actor">Actor/Actress
                          </label>
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <label>
                ...
                // Insert new tuple to corresponding table
                        if($_GET["job"]=="Actor")
                          $query = "INSERT INTO ".$_GET["job"]." VALUES (".(string)$newID.",'".$_GET["lname"]."','".$_GET["fname"]."','".$_GET["gender"]."','".$_GET["dob"]."',".$dod.");";
                        else
                          $query = "INSERT INTO ".$_GET["job"]." VALUES (".(string)$newID.",'".$_GET["lname"]."','".$_GET["fname"]."','".$_GET["dob"]."',".$dod.");";
                        ...
                        if(!$result = $db->query($query))
                          ...
                          $query = "UPDATE MaxPersonID SET id = ".(string)$newID;
                          //echo "$query<br>";
                          if(!$result = $db->query($query))
                            echo "Invalid query.";
                          else
