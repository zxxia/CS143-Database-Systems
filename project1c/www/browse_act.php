                  ...
                  <form class="form-horizontal style-form" method="get" action="<?php echo ($_SERVER["PHP_SELF"]);?>">
                    ...
                    <div class="form-group">
                      <div class="col-sm-7 col-sm-offset-4">
                        <button type="submit" class="btn btn-default">Find his/her information!</button>
                      </div>
                    </div>
                    ...
                    if(!$incomplete) {
                      ...
                      $query = "SELECT id,title,role FROM Movie, MovieActor WHERE Movie.id = MovieActor.mid AND MovieActor.aid=".$aid.";";
                      if(!$result = $db->query($query))
                        echo "Invalid Query.<br>";
                      else{

                        printf('<h4><i class="fa fa-angle-right"></i> His/Her works</h4>');
                        printf('<table class="table">');
                        printf('<thead>');
                        printf('<tr>');
                        $field_cnt = $result->field_count;
